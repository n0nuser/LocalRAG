...
| Eval | `evals/dataset/`, `evals/run_evals.py`, `evals/results/`, `evals/compare.py` | Dataset registry + RAGAS runner, versioned result contract/comparison; `localrag eval` and `localrag eval-compare` CLI commands |
